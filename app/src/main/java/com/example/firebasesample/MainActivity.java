...
//mStorageRef.child("gs://fir-sample-6aae1.appspot.com").getDownloadUrl().toString();
...
try{
    ...
    private void uploadFile() {
       /* if (mImageUri != null) {
            final StorageReference fileReference = mStorageRef.child(Constants.STORAGE_PATH_UPLOADS + System.currentTimeMillis()
